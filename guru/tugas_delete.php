...
if(isset($_GET['Kode'])){
	...
	$mySql	 = "SELECT file_tugas FROM tugas_belajar WHERE kd_tugas='$Kode' AND kd_guru='$kodeGuru'";
	...
	$my2Sql = "DELETE FROM tugas_belajar WHERE kd_tugas='$Kode' AND kd_guru='$kodeGuru'";
