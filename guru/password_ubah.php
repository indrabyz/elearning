...
if(isset($_POST['btnSimpan'])){
	...
	$cekSql = "SELECT * FROM guru WHERE kd_guru='$kodeGuru' AND password='".md5($txtPasswordLama)."' ";
	...
	if (count($pesanError)>=1 ){
		...
		$mySql 	= "UPDATE guru SET password=MD5('$txtPasswordLama') WHERE kd_guru='$kodeGuru'";
